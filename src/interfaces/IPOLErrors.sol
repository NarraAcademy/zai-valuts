...
interface IPOLErrors is IStakingRewardsErrors {
    ...
    /*                        INCENTIVE MANAGER                            */
    // Signature: 0x3c1484b0
    error InvalidIncentiveVaultWeights();
    // Signature: 0x4fe5882f
    error PayoutTokenIsNotIncentiveToken();
    // Signature: 0x86cbfa54
    error QueuedIncentiveVaultsAreEmpty();
    // Signature: 0xbe411d52
    error CurrentIncentiveVaultsAreInvalid();
}